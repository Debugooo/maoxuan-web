...
export const VOLUMES: VolumeGuide[] = [
  {
    ...
    bullets: ['阶级分析与社会调查', '武装割据与根据地建设', '反对本本主义', '哲学思辨与斗争经验认识论'],
    bookGroups: [
      {
        title: '第一次国内革命战争时期',
        items: [
  ...
  },
  {
    ...
    bullets: ['持久战战略方针与游击战术', '民族统一战线中的独立自主', '新民主主义革命理论', '反对自由主义与投降主义'],
    bookGroups: [
      {
        title: '抗日战争时期（上）',
        items: [
  ...
  },
  {
    ...
    bullets: ['整风运动与思想改造', '文艺为工农兵服务', '党的作风建设与根本宗旨', '争取抗日战争最终胜利'],
    bookGroups: [
      {
        title: '抗日战争时期（下）',
        items: [
  ...
  },
  {
    ...
    bullets: ['战略藐视与战术重视', '十大军事原则与决战指挥', '土地改革与人民战争', '革命到底与建国方略'],
    bookGroups: [
      {
        title: '第三次国内革命战争时期',
        items: [
  ...
  },
  {
    ...
    bullets: ['国民经济恢复与三大改造', '过渡时期的总路线', '正确处理人民内部矛盾', '整风反右与意识形态斗争'],
    bookGroups: [
      {
